                        ...
                        <div class="col-lg-12">
                            <div class="p-5">
                                <div class="text-center">
                                    <h1 class="h4 text-gray-900 mb-4"><b>{{ __('Registrasi') }}</b></h1>
                                </div>
                                ...
                                <form method="POST" action="{{ route('register') }}" class="user">
                                    ...
                                    <div class="form-group">
                                        <input type="no_telepon" class="form-control form-control-user" name="no_telepon" placeholder="{{ __('No. Telepon') }}" value="{{ old('no_telepon') }}" required>
                                    </div>
