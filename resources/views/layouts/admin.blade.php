...
<div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <a class="sidebar-brand d-flex align-items-center justify-content-center">
            ...
            <div class="sidebar-brand-text mx-3">CUSTOMER SERVICE</div>
            @endif
        </a>
        ...
        <li class="nav-item">
            <a class="nav-link" href="/service">
                <i class="fas fa-fw fa-file"></i>
                <span>{{ __('Service Barang') }}</span>
            </a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="/admin_helpdesk">
                <i class="fas fa-fw fa-file"></i>
                <span>{{ __('Helpdesk') }}</span>
            </a>
        </li>
        @if (Auth::check() && Auth::user()->role_id === 1)
        <div class="sidebar-heading">
        ...
        <li class="nav-item ">
            <a class="nav-link" href="/admin-diskon">
                <i class="fas fa-fw fa-file"></i>
                <span>{{ __('Diskon') }}</span>
            </a>
        </li>
        ...
        <footer class="sticky-footer bg-white">
            <div class="container my-auto">
                <div class="copyright text-center my-auto">
                    <span>Copyright &copy; Raka Computer {{ now()->year }}</span>
                </div>
            </div>
        </footer>
        <!-- End of Footer -->
